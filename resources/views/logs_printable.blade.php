    ...
    <div class="panel-body">
        ...
        <table style="width: 100%; background-color: transparent">
            ...
            <tr>
                ...
                @elseif($start!="" && $end=="")
                <td class="borderless" style="font-family:Arial, Helvetica, sans-serif;">ACTIVITY DATE: {{$logs}}<b style="text-decoration: underline;">{{$start}}</b></td>
        ...
        <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
            <thead style="text-align:center">
                ...
                <tr>
                    ...
                    <th colspan="3" style=" font-family:Arial, Helvetica, sans-serif;"> Activity </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3" style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">{{$row->TAL_ACTIVITY}}</td>
                    <td colspan="3" style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">{{$row->TAL_DATEADDED}}</td>
