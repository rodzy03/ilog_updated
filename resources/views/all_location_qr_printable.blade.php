     ...
     <div align="center">
        <figure>
            ...
            <figcaption style="font-family:Arial, Helvetica, sans-serif;">Republic of the Philippines</figcaption>
             ...
             <figcaption style="font-family:Arial, Helvetica, sans-serif; text-transform:uppercase">List of Qr Codes Generated By The System.</figcaption>
        </figure>
    ...
    <div class="panel-body">
      ...
      .borderless{
         ...
         <table style="width: 100%; background-color: transparent">
             <tr>
              ...
              <td class="borderless" style="width: 70%; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase; ">All Location</b></td>
      ...
      <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
          ...
          <tbody>
            ...
            {{ $qr_name = $row->RLI_LOCATIONID.$row->RLI_LOCATIONAME.".png" }} ;
               
            <tr>
                
                <td colspan="3" style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">{{$row->RLI_LOCATIONAME}}</td>
