...
<head>
    ...
    <div align="center">
        <figure>
            ...
            <figcaption style="font-family:Arial, Helvetica, sans-serif;">Emergency Logbook.</figcaption>
        </figure>
    ...
    <div class="panel-body">
        ...
        <table style="width: 100%; background-color: transparent">
            ...
            <tr>
                ...
                @elseif($start!="" && $end=="")
                    <td class="borderless" style="font-family:Arial, Helvetica, sans-serif;">EMERGENCY DATE: <b style="text-decoration: underline;">{{$start}}</b></td>
                @endif
            </tr>
        ...
        <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td  style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">{{$row->RET_TYPENAME}}</td>
                    <td  style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase; width:22%">{{$row->REL_DATEADDED}}</td>
                    <td  style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">{{$row->REL_EMERGENCYDESC}}</td>
