...
<head>
    ...
    <div align="center">
        <figure>
            ...
            <figcaption style="font-family:Arial, Helvetica, sans-serif;">Task Performance Logbook.</figcaption>
        </figure>
...
<body style="background: white">
        ...
        <table style="width: 100%; background-color: transparent">
            ...
            <tr>
                ...
                <td class="borderless" style="font-family:Arial, Helvetica, sans-serif;">&nbsp;<b style="text-decoration: underline;"></b></td>
                    @elseif($start!="" && $end=="")
                <td class="borderless" style="font-family:Arial, Helvetica, sans-serif;">TASK DATE: {{$logs}}<b style="text-decoration: underline;">{{$start}}</b></td>
                @endif
            </tr>
        ...
        <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
            <thead style="text-align:center">
                ...
                <tr>
                    ...
                    <th  style=" font-family:Arial, Helvetica, sans-serif;">Swim Task </th>
                    <th colspan="3" style="font-family:Arial, Helvetica, sans-serif;"> Time </th>
                    <!-- <th colspan="3" style="font-family:Arial, Helvetica, sans-serif;"> Reason For Inactivity </th> -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td  style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase; width:70% ">{{$row->RSL_SWIMCONTENT}}</td>
                    <td colspan="3" style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">{{$row->RSL_DATEADDED}}</td>
                    <!-- <td colspan="3" style=" text-align: center; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;"></td> -->
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="panel" style="text-align: center">
        ...
        <p style=" font-family:Arial, Helvetica, sans-serif; ">
            <u style="text-transform:uppercase">{{Auth::user()->name}}</u><br>
            Name<br><br>
