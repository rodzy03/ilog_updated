      ...
      .borderless{
         ...
         <table style="width: 100%; background-color: transparent">
             <tr>
              ...
              <td class="borderless" style="width: 70%; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase; ">Guard Name: <b>{{$name[0]->RAI_FIRSTNAME}} {{$name[0]->RAI_MIDDLENAME}} {{$name[0]->RAI_LASTNAME}}</b></td>
