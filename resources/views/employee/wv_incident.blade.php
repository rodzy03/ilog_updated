                ...
                <form >
                    ...
                    <div class="note note-secondary">
                        ...
                        <div class="note-content">
                            <center><h4><b>ADD INCIDENT INFORMATION</b></h4></center>
                            <p>&nbsp; </p>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <select style="background-color: white; text-transform:uppercase" name="selType" class="form-control">
                                        @foreach($type as $row)
										<option class="form-control" value="{{$row->RIT_TYPEID}}">{{$row->RIT_TYPE}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <button id="btn-report-i" type="button" class="button form-control" style="background-color: #d65656; color: white">Submit</button>
                </form>
   ...
   <!-- ================== BEGIN BASE JS ================== -->
    ...
    <script>
        ...
        $('#btn-report-i').click(function(){
            ...
            submit_report(data,"{{route('submit_incident')}}");
