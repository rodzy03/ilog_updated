                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12">
                        <div class="stats-content">
                            <label>&nbsp;Activity Start Date <span class="required"></span></label>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="stats-content">
                            <label>&nbsp;Activity End Date <span class="required"></span></label>
                ...
                <table id="data-table-default" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form method="POST" action="{{route('print_logs')}}">
                                {{ csrf_field() }}
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#loading').hide();
        text = ` You can filter data by selecting activity start date , end date and click the filter button.`;
    ...
    $('.filter_btn').click(function() {
        ...
        if(start === "" && end === "") {
            ...
            if(start != "" && end == "") {
                $('.start_p').val(start);
                $('#note_txt').html(`${text}<br>You set activity log date (${start}) .`);
            }
            else {
                $('.start_p').val(start);
                $('.end_p').val(end);
                $('#note_txt').html(`${text}<br>You set activity log start date from (${start}) to (${end}) .`);
            }
        }
