        ...
        <div class="panel ">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a><i class="fa fa-question-circle fa-fw text-info m-r-5"></i> INCIDENT TYPE LIST </a>
                </h4><br>
                ...
                <button class="form-control col-md-3 btn btn-inverse" data-toggle="modal" data-target="#modal-add-inci"><i class="fa fa-plus "></i>&nbsp;Add Incident Type</button>
            </div>
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold; text-transform:uppercase">{{$row->RIT_TYPE}}</td>
                                <td style="width: 20%;">
                                    <div class="row">
                                        @if($row->RIT_ACTIVE == 1)

                                        <a id=edit vals="{{$row->RIT_TYPEID}}" class="btn btn-info" data-toggle="modal" data-target="#modal-edit"><i class="fa fa-edit text-white"></i></a>&nbsp;
                                        <a id=deact vals="{{$row->RIT_TYPEID}}" class="btn btn-purple" data-toggle="tooltip" title="Deactive"><i class="fa fa-ban text-white"></i></a>
                                        @else
                                        <a id=act vals="{{$row->RIT_TYPEID}}" class="btn btn-success" data-toggle="tooltip" title="Activate"><i class="fa fa-redo text-white"></i></a>&nbsp;
                    ...
                    <fieldset>
                        <div class="note note-with-left-icon m-b-15">
                            ...
                            <div class="note-content text-left">
                                <h4><b>IMPORT INCIDENT TYPE</b></h4>
                                <p>
...
<script>
    ...
    $('#btnRegister').click(function() {
        ...
        var url = "{{route('import_incident_type')}}";
