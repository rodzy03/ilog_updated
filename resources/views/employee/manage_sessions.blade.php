        ...
        <div class="panel ">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a><i class="fa fa-question-circle fa-fw text-info m-r-5"></i> PERSONNEL CURRENT SESSIONS </a>
                </h4>
            ...
            <div id="faq-2">
                <div class="panel-body">
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th class="text-nowrap">Personnel Information</th>
                                <th class="text-nowrap">Shift</th>
                                <th class="text-nowrap">Logged Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <b>{{$row->RAI_LASTNAME}} {{$row->RAI_LASTNAME}} </b>({{$row->RAT_TYPE}})</td>
                                <td style="text-transform:uppercase">{{$row->SHIT}}</td>
                                <td style="text-transform:uppercase">{{$row->LOGGED_STATUS}}</td>
                                <td style="text-transform:uppercase">{{$row->TGS_APPVERSION}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
