        ...
        <div class="panel ">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a><i class="fa fa-question-circle fa-fw text-info m-r-5"></i> Job Role LIST </a>
                </h4><br>
                {{--<button class="form-control col-md-3 btn btn-info" data-toggle="modal" data-target="#modal-add">import</button>--}}
                <button class="form-control col-md-3 btn btn-inverse" data-toggle="modal" data-target="#modal-add-swim"><i class="fa fa-plus">&nbsp;</i>Add New Job Role&nbsp;</button>
            </div>
            ...
            <div id="faq-2">
                <div class="panel-body">
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th class="text-nowrap">Job Role Name</th>
                        ...
                        <tbody>
                            @foreach($data as $row)
                            <tr>
                                <td style="text-transform: uppercase;"><b>{{$row->RAT_TYPE}}</b></td>
                                <td style="width: 20%;">
                                    <div class="row">
                                        

                                        <a id=edit vals="{{$row->RAT_TYPEID}}" class="btn btn-info" data-toggle="modal" data-target="#modal-edit"><i class="fa fa-edit text-white"></i></a>&nbsp;
                                        {{--@if($row->RST_ACTIVE == 1)
                                        <a id=deact vals="{{$row->RAT_TYPEID}}" class="btn btn-purple" data-toggle="tooltip" title="Deactive"><i class="fa fa-ban text-white"></i></a>
                                        @else
                                        <a id=act vals="{{$row->RAT_TYPEID}}" class="btn btn-success" data-toggle="tooltip" title="Activate"><i class="fa fa-redo text-white"></i></a>&nbsp;
