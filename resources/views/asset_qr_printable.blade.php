      ...
      .borderless{
         ...
         <table style="width: 100%; background-color: transparent">
             <tr>
              ...
              <td class="borderless" style="width: 70%; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase; ">Asset Name: <b>{{$name[0]->ASSET_NAME}}</b></td>
          ...
          <td class="borderless" style="width: 70%; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase; ">LOCATION NAME: {{$name[0]->RLI_LOCATIONAME}}</td>
